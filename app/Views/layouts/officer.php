...
<head>
    ...
    <title><?= htmlspecialchars((string) ($title ?? 'Officer Workspace')) ?></title>
    <style>
        :root {
            --bg: #f8fafc;
            --surface: #ffffff;
        ...
        * { box-sizing: border-box; }
        ...
        .header { padding: 18px 22px; background: #f0f9ff; border-bottom: 1px solid var(--line); }
...
<body>
    <main class="shell">
        <header class="header">
            ...
            <h1><?= htmlspecialchars((string) ($title ?? 'Officer Workspace')) ?></h1>
        </header>

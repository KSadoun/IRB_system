...
<head>
    ...
    <title><?= htmlspecialchars((string) ($title ?? 'Manager Dashboard')) ?></title>
    <style>
        :root {
            --bg: #f7faf7;
            --surface: #ffffff;
        ...
        * { box-sizing: border-box; }
        ...
        .header { padding: 18px 22px; background: #f0fdf4; border-bottom: 1px solid var(--line); }
...
<body>
    <main class="shell">
        <header class="header">
            ...
            <h1><?= htmlspecialchars((string) ($title ?? 'Manager Dashboard')) ?></h1>
        </header>
